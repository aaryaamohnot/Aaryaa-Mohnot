weather-feels:
Compares real-time data from multiple weather apps and surfaces what the conditions actually feel like — not just the temperature, but wind chill, humidity, UV index, and cloud cover all rolled into one view.
Built because weather apps lie. 72°F sounds fine until you're standing in 20mph wind with 80% humidity.
